...
- dueDate став ТІЛЬКИ якщо в тексті явно згадано час — конкретна дата («15-го», «у неділю») або відносне формулювання («завтра», «до п'ятниці», «до кінця місяця»). Формат строго YYYY-MM-DD. Рахуй відносно сьогоднішньої дати (${today}); «завтра» — наступний день, і так далі. Якщо часу не згадано — НЕ додавай dueDate.
